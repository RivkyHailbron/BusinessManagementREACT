            ...
            >
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="font-medium text-gray-900">{meeting.customerName}</p>
                    <p className="text-sm text-gray-600">{meeting.serviceName}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="text-sm text-gray-900">{meeting.customerEmail}</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <p className="text-sm text-gray-900">{meeting.customerPhone}</p>
                    <span className={`inline-block px-2 py-1 text-xs rounded-full ${
                      meeting.status === 'confirmed' 
                        ? 'bg-green-100 text-green-800' 
                        : 'bg-yellow-100 text-yellow-800'
                    }`}>
                      {meeting.status === 'confirmed' ? 'מאושר' : 'ממתין'}
                    </span>
                  </div>
                </div>
              </div>
